                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="{{ url('/') }}">
                            ...
                            <h2 class="brand-text text-primary ms-1">Municipalidad SJL</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="card-text mb-2">Inicie sesión con su cuenta municipal.</p>


                                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST" >
                                    @csrf
                                    <div class="mb-1">
                                        <label class="form-label" for="login-email">Documento de Identidad</label>
                                        <input class="form-control" id="dni" type="text" placeholder="" aria-describedby="login-email" autofocus="" tabindex="1" name="dni" value="{{ old('dni') }}" required autofocus autocomplete="dni" />
                                    </div>
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label" for="login-password">Contraseña</label><a href="{{ route('password.request') }}"></a>
                                        </div>
